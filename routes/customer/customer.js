...
exports.addNewCustomer = (req, res) => {
    new customerModel({
        ...
        ratePerBottel: req.body.ratePerBottel,
...
exports.updateCustomer = (req, res) => {
    if (req.body._id) {
        customerModel.findOneAndUpdate({ _id: req.body._id }, {
            $set: {
                name: req.body.name, address: req.body.address, ratePerBottel: req.body.ratePerBottel, rentPerDispenser: req.body.rentPerDispenser
            }
        }, (err, data) => {
            if (err) {
                res.json({
